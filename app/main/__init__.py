...
description = '''
    Cette API est conçue pour gérer les opérations liées à un projet immobilier.
    Elle fournit des endpoints sécurisés pour créer, consulter, mettre à jour et supprimer des biens immobiliers,
    gérer les clients, les transactions et les réservations.
    La plupart des opérations nécessitent une authentification afin d'assurer la sécurité et un usage approprié.
'''
